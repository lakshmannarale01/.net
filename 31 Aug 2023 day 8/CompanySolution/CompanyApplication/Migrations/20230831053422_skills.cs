        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillsSkillName = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeSkill", x => new { x.EmployeesId, x.SkillsSkillName });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeSkill_skills_SkillsSkillName",
                        column: x => x.SkillsSkillName,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeSkill_SkillsSkillName",
                table: "EmployeeSkill",
                column: "SkillsSkillName");
