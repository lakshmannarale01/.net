namespace PIzzaStoreModelLibrary
{
    public class Pizza : IEquatable<Pizza>, IComparable<Pizza>
    {
        ...
        public string Name { get; set; }= string.Empty;  //nullble string sathi =string.Empty ghetlay 
        public int Quantity { get; set; }
        public double Price { get; set; }
        public string? Type { get; set; } // nullable string sathi string chya nantr ? lavalay which is string? varchi ani hi method pramane karta yet 
